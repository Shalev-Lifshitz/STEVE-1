...
from steve1.VPT.agent import MineRLAgent, ENV_KWARGS
from steve1.data.generation.FrameBuffer import FrameBuffer, QueueFrameBuffer
from steve1.data.generation.vpt_agents import VPT_AGENT_PAIRS
from steve1.mineclip_code.load_mineclip import load
from steve1.helpers import timeit_context
    ...
    try:
        while num_timesteps < max_timesteps:
            ...
            with timeit_context('env step'):
                minerl_obs, _, _, _ = env.step(minerl_action)
